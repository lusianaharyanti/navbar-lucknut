    ...
    mr.dropdowns.repositionDropdowns = function($){
        $('.dropdown__container').each(function(){
            var container, containerOffset, masterOffset, menuItem, content;
                ...
                jQuery(this).css('center', '');

                container       = jQuery(this);  
                containerOffset = container.offset().center;
                masterOffset    = jQuery('.containerMeasure').offset().center;
                menuItem        = container.closest('.dropdown').offset().center;
                content         = null;
                
                container.css('center',((containerOffset)-(masterOffset)));
